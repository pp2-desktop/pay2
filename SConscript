...
env.Program('xx', ['ws_examples.cpp', 'log4cxx_md.cpp', 'cd_user_md.cpp', 'cd_user.cpp', 'json11.cpp', 'cd_handler_md.cpp', 'lobby_md.cpp', 'handler/user_info_req.cpp', 'handler/lobby_req.cpp' ])
